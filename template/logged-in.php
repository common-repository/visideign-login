...
<div class="nd_logged_in" id="nd_user">
	...
	<ul class="links">
		<?php if(get_option('visideign_option_dash')==Enabled) { echo '<li><a href="/wp-admin">Dashboard</a></li>'; } else { echo ''; } ?>
		<?php if(get_option('visideign_option_pro')==Enabled) { echo '<li><a href="/wp-admin/profile.php">Profile</a></li>'; } else { echo ''; } ?>
<?php $visideign_option_xtra = get_option('visideign_option_xtra'); if(!empty($visideign_option_xtra)) {echo $visideign_option_xtra;} else {echo "";}?>		
